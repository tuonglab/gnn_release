...
# Load the two files
file1 = pd.read_csv('/scratch/project/tcr_ml/gnn_release/icantcrscoring/seekgene/summary.csv')
file2 = pd.read_csv('/scratch/project/tcr_ml/gnn_release/icantcrscoring/pica/summary.csv')
...
plt.boxplot([scores_cancer, scores_control], labels=['Seekgene (Cancer)', 'PICA (Control)'])
