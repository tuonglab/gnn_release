...
# File paths
control_file = '/scratch/project/tcr_ml/gnn_release/model_2025_bulk/val_control_scores/metric_scores.csv'
cancer_file = '/scratch/project/tcr_ml/gnn_release/model_2025_bulk/theragen_scores/metric_scores.csv'
