...
python /scratch/project/tcr_ml/gnn_release/graph_generation/process.py \
    --root-dir  /scratch/project/tcr_ml/gnn_release/test_data_v2/control_leftovers \
    --directory /scratch/project/tcr_ml/gnn_release/test_data_v2/control_leftovers/raw \
    # --cancer
