...
python /scratch/project/tcr_ml/gnn_release/graph_generation/create_edgelist.py \
    --tar-dir /scratch/project/tcr_ml/colabfold/results_2/prediction/control_leftovers \
    --output-base-dir /scratch/project/tcr_ml/gnn_release/test_data_v2/control_leftovers/raw
